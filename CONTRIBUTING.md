...
`eclipse-ecsp/vehicle-profile` up to date and always improving! There are a few guidelines that we need
contributors to follow to keep the project consistent, as well as allow us to keep
maintaining `eclipse-ecsp/vehicle-profile` in a reasonable amount of time.
...
1. Please make sure there is no [open issue](https://github.com/eclipse-ecsp/vehicle-profile/issues) yet.
...
- Submit a pull request from your topic branch to the [main](https://github.com/eclipse-ecsp/vehicle-profile) branch on the `eclipse-ecsp/vehicle-profile` repository.
...
- Ensure that the PR is tagged with related [issue](https://github.com/eclipse-ecsp/vehicle-profile/issues) it intends to resolve.
